...
public final class Encoder {
     ...
     */
    public Bitmap encode(final String content,Bitmap logo){
        return encode(content, mConfigBuilder.mOutputBitmapWidth, mConfigBuilder.mOutputBitmapHeight,logo);
    }
     ...
     * @return Bitmap对象，如果生成失败，返回null。
     */
    public Bitmap encode(final String content, int width, int height,Bitmap logo){
